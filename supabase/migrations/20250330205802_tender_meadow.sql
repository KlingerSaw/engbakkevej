/*
  # Update bylaws content with complete text

  1. Changes
    - Clear existing bylaws content
    - Insert complete bylaws content with proper HTML formatting
    - Maintain section numbers and structure
*/
...
(2, 'Medlemmer og deres forhold til foreningen', '<div class="prose">
  <h2>Medlemmer og deres forhold til foreningen</h2>
  <ol start="4">
...
(5, 'Bilagskontrollanter og regnskab', '<div class="prose">
  <h2>Bilagskontrollanter og regnskab</h2>
  <ol start="15">
