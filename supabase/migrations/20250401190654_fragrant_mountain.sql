/*
  # Remove duplicate h2 headings from bylaws content

  1. Changes
    - Update bylaws content to remove duplicate h2 headings
    - Keep the content structure intact
    - Maintain all other formatting
*/

UPDATE bylaws 
SET content = '<div class="prose">
  <ol>
